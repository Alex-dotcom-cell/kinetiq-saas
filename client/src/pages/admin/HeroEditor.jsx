...
const HeroEditor = () => {
  ...
  const fetchHero = async () => {
    try {
      ...
      showMessage('Failed to load hero section', 'error');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showMessage(error.message || 'Failed to update hero section', 'error');
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <AdminLayout>
      <div>
        <h2 className="text-3xl font-bold text-white mb-8">Edit Hero Section</h2>
